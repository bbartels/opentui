import { describe, test, expect, beforeEach, afterEach } from "#test-runtime"
...
describe("TestRecorder", () => {
  ...
  test("should capture changing content across frames", async () => {
    ...
    // NOTE: Should this fail, make sure the sleep durations are in sync with maxFps of the renderer
